...
export default function Footer() {
    return (
        <footer className="relative z-10 mt-10 mx-auto max-w-[980px] px-4 safe-bottom">
            <div className="bg-black/10 border border-gray-400/30 border-t-gray-400/60 rounded-2xl">
                <div className="rounded-2xl bg-white/10 backdrop-blur-xl shadow-xl mx-auto flex items-center justify-between gap-4 px-6 py-10 text-center text-sm text-white/70">
                    {/* Logo */}
